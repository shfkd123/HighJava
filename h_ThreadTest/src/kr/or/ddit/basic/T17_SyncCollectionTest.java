...
/**
 	...
 	그래서, 동기화가 필요한 프로그램에서 이럼 Collection들을 사용하려면 동기화 처리를 한 후에 사용해야 한다.
 */
	// 동기화를 하지 않을 경우
	private static List<Integer> list1 = new ArrayList<>();
	
	//동기화 하는 경우
	private static List<Integer> list2 = Collections.synchronizedList(new ArrayList<>());//파라미터: 동기화 처리할 List
